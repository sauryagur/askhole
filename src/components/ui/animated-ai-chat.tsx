...
import { Paperclip, SendIcon, XIcon, LoaderIcon, Command } from "lucide-react";

import { BrainCircuit, FileText, FolderGit2, Flame, Zap } from "lucide-react";
  ...
  const commandSuggestions: CommandSuggestion[] = [
    {
      ...
      label: "Switch Model",
      description: "Pick a different Ollama brain (llama3.2, mistral...)",
      prefix: "/model",
    },
    {
      icon: <FileText className="w-4 h-4" />,
      label: "Eat Files",
      description: "Upload PDFs, MDs, or TXT to feed Askie",
      prefix: "/ingest",
    },
    {
      icon: <FolderGit2 className="w-4 h-4" />,
      label: "Eat Directory",
      description: "Point to a folder, Askie eats everything inside",
      prefix: "/dir",
    },
    {
    ...
    },
    {
      ...
      label: "Random Mode",
      description: "Askie answers with zero filter, max chaos",
      prefix: "/chaos",
    },
  ];
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 text-sm text-white/70">
                <span>Askie is reading your garbage</span>
                <TypingDots />
              </div>
            </div>
          </motion.div>
